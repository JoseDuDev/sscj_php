<?php 
    ...
    function atualizaFoto($id, $desc) {
        $result = "UPDATE jornal_fotos SET descricao = '". $desc ."' WHERE id = ". $id;
    ...
    function deletaFoto($id) {
        ...
        $query = "SELECT foto FROM jornal_fotos WHERE id = ".$id;
        ...
        $query = "DELETE FROM jornal_fotos WHERE id = ".$id;
    ...
    function deletaFotos($id) {
        ...
        foreach($retorno['itens'] as $item) {
            $query = "SELECT foto FROM jornal_fotos WHERE id = ".$item;
            ...
            if(mysql_num_rows($result) > 0) {
                ...
                $query = "DELETE FROM jornal_fotos WHERE id = ".$item;
                mysql_query($query);   
            }
        }
    ...
    function imprimeConteudo($tp, $id) {
        if($tp == 1) {
            ...
            $result = mysql_query("SELECT coalesce(descricao, '') as descricao FROM jornal_fotos WHERE id =". $id);          
