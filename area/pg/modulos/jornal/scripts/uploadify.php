...
if (!empty($_FILES)) {
    ...
    $maximo = mysql_result(mysql_query("SELECT COALESCE(MAX(id_o),0)+1 as maximo FROM jornal_fotos"),0,'maximo');
	$insereprodutos = mysql_query("INSERT INTO jornal_fotos (id_jornal, foto, id_o) VALUES ($id_album, '".$img."', $maximo)");
