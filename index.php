...
<meta content='https://<?php echo $GLOBALS['config']['url']; ?>/<?php echo $_SESSION['imagem_atual']; ?>' property='og:image'>
...
<div id="topo">
	<div class="util">
		<div class="cabecalho">
			...
			<?php if($GLOBALS['config']['facebook']!=''){ ?><a href="https://<?php echo $GLOBALS['config']['facebook']; ?>" target="_blank"><div class="facebook"></div></a><?php } ?>
...
<div class="rodape">
	<div class="util">
		...
		<a href="https://www.agenciaarcanjo.com.br" target="_blank"><div class="arcanjo"></div></a>
	</div>
</div>
