		...
		<ul class="vemais">
			...
			for( $i=0; $i<count($nots); $i++ ){
				if($_GET['noticia'] != $nots[$i]['url']){
					...
					echo '<li>';
						echo '<div class="image"><img src="https://'.$nots[$i]['local'].'area/'.$nots[$i]['imagem'].'" width="70" height="60" alt="'.$nots[$i]['titulo'].'" title="'.$nots[$i]['titulo'].'" /></div>';
	...
	<div class="util">
		<div class="utiln">
			...
			<div class="divulgacao">
				<a href="https://www.facebook.com/share.php?u=https://<?php echo $_SERVER['SERVER_NAME'].$_SERVER ['REQUEST_URI']; ?>&t=<?php echo urlencode($dados->titulo); ?>" target="_blank"><div class="compartilhe"><img src="img/bt-compartilhe.png" width="151" height="38" alt="Compartilhe está Notícia" title="Compartilhe está Notícia" /></div></a>
				<div onclick="window.print();" class="imprimir"></div>
				<div onclick="indica();" class="indicar"></div>
				<a href="https://www.facebook.com/share.php?u=https://<?php echo $_SERVER['SERVER_NAME'].$_SERVER ['REQUEST_URI']; ?>&t=<?php echo urlencode($dados->titulo); ?>" target="_blank"><div class="face"></div></a>
			</div>
