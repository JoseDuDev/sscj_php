...
define ('MAX_FILE_SIZE', 20485760);			// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
...
//Browser caching
define ('BROWSER_CACHE_MAX_AGE', 1064000);		// Time to cache in the browser
